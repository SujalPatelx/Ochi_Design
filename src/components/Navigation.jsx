...
function Navigation() {
    return (
        <div style={{
        ...
        }} className='z-[999] w-full h-16 overflow-hidden  bg-transparent px-14 py-4 font-[Neue-Montreal] font-[400]' >
            ...
            <div className='w-full flex justify-between'>
                ...
                <div className='flex  gap-6 text-xl'>
                    {
                        [["Services", "Services"], ["Our work", "Our work"], ["About us", "About us"], ["Insights", "Insights"], ["Contact us", "Contact us"]].map((item, index) => {
                            return (
                                <div className='relative overflow-hidden'>
                                    <a key={index} className={`w-fit h-fit group
                                     transition ease-in-out duration-300 flex flex-col gap-10 font-normal text-[1.1vw] cursor-pointer text-[#212121] leading-none mt-2 ${index == 4 && "ml-[15vw]"}`}>
                                        <div className='group-hover:-translate-y-10 transition ease-in-out duration-[450ms]  '>{item[0]}</div>
                                        <div className='group-hover:translate-y-0 transition ease-in-out duration-[450ms] translate-y-10 absolute'>{item[1]}</div>
                                    </a>
                                </div>
                            )
                        })
