...
const Footer = () => {
    return (
        <div className='h-[110vh] w-full'>
            <div data-scroll data-scroll-section className='h-full w-full pt-[10vh] px-[4vw] flex flex-col justify-around'>
                <div className='flex'>
                    <div className='w-full '>
                        <p className='uppercase font-[Founder-Grotesk] text-[9vw] leading-[14vh]'>eye-<br />opening</p>
                    </div>
                    <div className='w-full '>
                        <div>
                            <p className='uppercase font-[Founder-Grotesk] text-[9vw] leading-[14vh]'>presentation</p>
                        </div>
                        <div className='flex justify-between font-[Neue-Montreal]'>
                            <div>
                                ...
                                <div className='mt-[4vh] flex flex-col gap-[2vh]'>
                                    <p>S:</p>
                                    <div>
                                        <p className='relative link-under w-fit'>202-1965 W 4th Ave</p>
                                        <p className='relative link-under w-fit'>Vancouver, Canada</p>
                                        <p className='relative mt-[4vh] link-under w-fit'>30 Chukarina St</p>
                                        <p className='relative link-under w-fit'>Lviv, Ukraine</p>
                                    </div>
                                </div>
                                <div className='mt-[4vh] flex flex-col gap-[2vh]'>
                                    <p>E:</p>
                                    <div>
                                        <p className='relative link-under w-fit'>hello@ochi.design</p>
                                    </div>
                                </div>
                            </div>
                            <div className='self-center'>
                                <div className='mt-[10vh] flex flex-col gap-[2vh]'>
                                    <p>S:</p>
                                    <div>
                                        <p className='relative link-under w-fit'>Home</p>
                                        <p className='relative link-under w-fit'>Services</p>
                                        <p className='relative link-under w-fit'>Our work</p>
                                        <p className='relative link-under w-fit'>About us</p>
                                        <p className='relative link-under w-fit'>Insights</p>
                                        <p className='relative link-under w-fit'>Contact us</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className='flex justify-between font-[Neue-Montreal]'>
                    ...
                    <p className='text-[#212121]/20 font-[500]'>&copy;ochi design 2024. Legal Terms</p>
                    <p className='text-[#212121] font-[500]'>Website with 🧡 by @sujal</p>
                </div>
            </div>
        </div>
    )
